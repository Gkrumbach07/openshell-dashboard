...
> **Note:** ADR 0013 proposes migrating the BFF to `openshell-sdk-go` (PR #2). If that lands, this skill retires — `backend/proto/` and `backend/gen/` go away, and API updates become an SDK version bump. Until then, this is the process.
