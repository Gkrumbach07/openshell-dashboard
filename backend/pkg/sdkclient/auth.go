...
func (c ContextAuthProvider) GetRequestMetadata(ctx context.Context, _ ...string) (map[string]string, error) {
...
func (c ContextAuthProvider) RequireTransportSecurity() bool {
	return c.RequireTLS
}
