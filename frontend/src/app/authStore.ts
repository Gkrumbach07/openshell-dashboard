...
export const getToken = (): string | null => window.sessionStorage.getItem(TOKEN_KEY);
...
export const isDevSession = (): boolean => window.sessionStorage.getItem(DEV_MODE_KEY) === 'true';
