...
- **Standalone repo, npm downstream** ([ADR 0001](docs/adrs/0001-npm-package-consumption-model.md)). Community project. Zero imports from any downstream platform. Downstream installs the npm package.
